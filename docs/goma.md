...
Run the `goma` server (to proxy to RBE):
    ...
    goma/server $ go run \
        ...
        -platform-container-image 'docker://ghcr.io/catthehacker/ubuntu:act-22.04@sha256:9425bc2b961fa9e5da21474efbd997495d505242ebb4dbb7cdea1c798e3cf13b' \
        -insecure-remoteexec
