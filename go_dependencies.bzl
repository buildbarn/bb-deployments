...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:Hbpxukk2ifNQfP2um03foB+aeZ3WT5fBcZK8YLmCOk0=",
        version = "v0.0.0-20230208101541-73a536225e96",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:VOkJ+OVef2zYp4zTsGCltlEaI+2AD5YRWwWjuLXzs3g=",
        version = "v0.0.0-20230208220714-fd356c80abcf",
    )
    go_repository(
