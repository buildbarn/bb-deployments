...
{
  dashboards+:: {
    'bb-scheduler.json': simpledash.dashboard(
      title='BB Scheduler',
      templates=[
        simpledash.template(
        ...
        simpledash.row(
          ...
          panels=[
            simpledash.graph(
              ...
              targets=[
                simpledash.graphTarget(
                  expr=prettifyPlatform('instance_name_prefix_platform_size_class:buildbarn_builder_in_memory_build_queue_tasks_queued:irate1m{instance_name_prefix=~"$instance_name_prefix",platform=~\'$platform\',%s="$cluster"}') % $._config.clusterLabel,
            ...
            simpledash.graph(
              ...
              targets=[
                simpledash.graphTarget(
                  expr=prettifyPlatform('instance_name_prefix_platform_size_class:buildbarn_builder_in_memory_build_queue_tasks_executing:irate1m{instance_name_prefix=~"$instance_name_prefix",platform=~\'$platform\',%s="$cluster"}') % $._config.clusterLabel,
                  legendFormat='{{instance_name_prefix}} [{{platform}}] {{size_class}}',
                ),
              ],
            ),
            simpledash.graph(
              ...
              targets=[
                simpledash.graphTarget(
                  expr=prettifyPlatform('grpc_code_instance_name_prefix_platform_result_size_class:buildbarn_builder_in_memory_build_queue_tasks_completed:irate1m{instance_name_prefix=~"$instance_name_prefix",platform=~\'$platform\',%s="$cluster"}') % $._config.clusterLabel,
            ...
            simpledash.graph(
              ...
              targets=[
                simpledash.graphTarget(
                  expr=prettifyPlatform('instance_name_prefix_platform_size_class:buildbarn_builder_in_memory_build_queue_tasks_removed:irate1m{instance_name_prefix=~"$instance_name_prefix",platform=~\'$platform\',%s="$cluster"}') % $._config.clusterLabel,
                  legendFormat='{{instance_name_prefix}} [{{platform}}] {{size_class}}',
                ),
              ],
            ),
        ...
        simpledash.row(
          ...
          panels=[
            simpledash.graph(
              ...
              targets=[
                simpledash.graphTarget(
                  expr=prettifyPlatform('instance_name_prefix_platform_size_class:buildbarn_builder_in_memory_build_queue_tasks_%s:sum{instance_name_prefix=~"$instance_name_prefix",platform=~\'$platform\',%s="$cluster"}' % [std.asciiLower(stage), $._config.clusterLabel]),
                  legendFormat='{{instance_name_prefix}} [{{platform}}] {{size_class}}',
                ),
              ],
            )
        ...
        simpledash.row(
          ...
          panels=[
            simpledash.heatmap(
              title=stage,
              width=1 / 3,
              unit=simpledash.unitSeconds { decimals: 0 },
              targets=[
                simpledash.heatmapTarget(
                  expr='sum(instance_name_prefix_le_platform_size_class:buildbarn_builder_in_memory_build_queue_tasks_%s_duration_seconds_bucket:irate1m{instance_name_prefix=~"$instance_name_prefix",platform=~\'$platform\',%s="$cluster"}) by (le)' % [std.asciiLower(stage), $._config.clusterLabel],
                ),
              ],
            )
            for stage in ['Queued', 'Executing', 'Completed']
        ...
        simpledash.row(
          ...
          panels=[
            simpledash.heatmap(
              ...
              targets=[
                simpledash.heatmapTarget(
                  expr='sum(instance_name_prefix_le_platform_size_class:buildbarn_builder_in_memory_build_queue_tasks_executing_retries_bucket:irate1m{instance_name_prefix=~"$instance_name_prefix",platform=~\'$platform\',%s="$cluster"}) by (le)' % $._config.clusterLabel,
                ),
              ],
            ),
          ],
